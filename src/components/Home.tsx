...
const Home = () => {
  ...
  return (
    ...
    >
<div
  className="absolute inset-0 w-full h-full block sm:hidden bg-cover bg-center"
...
<div
  className="absolute inset-0 w-full h-full hidden sm:block bg-cover bg-center"
  ...
  <div className="absolute inset-0 bg-black/20"></div>
      ...
      <div className="relative z-10 text-center p-4 sm:p-6 md:p-12 max-w-xl sm:max-w-2xl md:max-w-3xl w-full">
        ...
        <div className="mt-5 sm:mt-6 flex justify-center">
          <Button variant="glow" onClick={() => navigate("services")} className="px-4 py-2 sm:px-6 sm:py-3 text-sm sm:text-base rounded-full">Explore</Button>
        </div>
      </div>
    </section>
  );
